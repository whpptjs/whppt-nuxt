...
export default options => ({
  ...
  getters: {
    inEditor(state) {
      return state.activeMenuItem === 'select';
    },
  },
  actions: {
    ...
    doEditInSidebar({ commit }, type) {
      commit('EDIT_IN_SIDEBAR_CHANGED', type);
    },

    doEditInModal({ commit }, type) {
      commit('EDIT_IN_MODAL_CHANGED', type);
    },
  },
  mutations: {
    ...
    PUSHED_SELECTED_COMPONENT_VALUE(state, { path, value }) {
      ...
      if (!Array.isArray(currentValue))
        throw new Error('Value provided is not type Array, please provide an Array or use the setSelected');
    ...
    EDIT_IN_SIDEBAR_CHANGED(state, type) {
    ...
    /* 
      @deprecated
      compatibility for EDIT_IN_SIDEBAR_CHANGED
    */
    ...
    EDIT_IN_MODAL_CHANGED(state, type) {
    ...
    /* 
      @deprecated 
      compatibility for EDIT_IN_MODAL_CHANGED
    */
