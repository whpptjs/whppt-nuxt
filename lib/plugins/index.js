...
import { checkSlug, createPage, deletePage, loadPage, publishPage, savePage, unpublishPage } from './pluginDefaults';
...
// type can be siteSettings, pageSettings, dashboard
function getAdditionalComponents(type) {
  ...
  for (const _type of pluginTypes) {
    ...
    additionalTabs.push(_type[type]);
  }
