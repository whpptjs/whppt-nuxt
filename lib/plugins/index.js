...
export default (context, inject) => {
    ...
    tracking: {
      linkClicked: element => {
        const trackingValues = {
          ...
          'gtm.element': element,
          'gtm.elementUrl': element.attributes.href.value,
          'gtm.elementTarget': element.attributes.target.value,
        };
  ...
  directives.imageFreeform(context, menuIsInState, MENUSTATES);
