<template>
  <div>
    <h1>Carousel</h1>
    <whppt-select v-model="editingCarouselItem" :items="editingCarouselItems" action="Select an item to edit ..." />
    ...
    <whppt-tabs v-if="editingCarouselItem" class="whppt-carousel__item-details" ref="carouselImageTabs">
      <whppt-tab title="Text">
        <item-text :editingCarouselItem="editingCarouselItem" />
      </whppt-tab>
...
export default {
  name: 'EditorCarousel',
  components: { WhpptTextInput, WhpptTab, WhpptTabs, WhpptSelect, ItemText, Gallery, Cropping },
  data() {
    return {
